...
def lista_impressoras_instaladas()-> List[str]:
    ...
    return [impressora[2] for impressora in win32print.EnumPrinters(win32print.PRINTER_ENUM_LOCAL, None, 1)]

def definir_impressora_padrao(nome_impressora_padrao:str)-> bool:
    #testa se impressora existe
    if(not(nome_impressora_padrao in lista_impressoras_instaladas())):#Se o nome da impressora não tiver nas impressoras listadas, lança erro
